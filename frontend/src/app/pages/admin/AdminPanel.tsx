...
export default function AdminPanel() {
  const [activeTab, setActiveTab] = useState('job-moderation');
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden font-sans">
      ...
      {/* Sidebar */}
      <aside className="w-64 bg-gray-900 text-white flex flex-col hidden md:flex flex-shrink-0">
        ...
        <div className="max-w-7xl mx-auto p-8">
          ...
          <header className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="text-gray-500 mt-1 font-medium">Review and approve new job postings.</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div className="bg-gray-900 text-white rounded-2xl shadow-sm p-6 flex flex-col justify-between relative overflow-hidden">
              ...
              <div>
                <h3 className="text-lg font-bold mb-6 text-gray-100">Moderation Queue</h3>
              ...
              <button className="w-full mt-6 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-xl transition-colors shadow-lg shadow-blue-900/20">
                Review Queue
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="p-6 border-b border-gray-200 flex items-center justify-between">
              <h3 className="text-lg font-bold text-gray-900">Pending Job Approvals</h3>
